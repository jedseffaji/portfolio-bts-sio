...
const PDF_HREF = "/Comptes%20rendus/stages/xpertdiagimmo.pdf";

export default function Page() {
  return (
    <Section
      title="Mission XpertDiag’Immo"
      subtitle="Prévisualisation du document de mission du stage XpertDiag’Immo."
    >
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        >
          <iframe
            src={PDF_HREF}
            title="Prévisualisation mission XpertDiag’Immo"

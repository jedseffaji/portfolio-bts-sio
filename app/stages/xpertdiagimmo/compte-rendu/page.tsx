...
const PDF_HREF = "/Comptes%20rendus/xpertdiagimmo.pdf";

export default function Page() {
  return (
    <Section
      title="Compte rendu XpertDiag’Immo"
      subtitle="Prévisualisation du compte rendu de stage XpertDiag’Immo."
    >
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-5">
        ...
        >
          <iframe
            src={PDF_HREF}
            title="Prévisualisation compte rendu XpertDiag’Immo"
